...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const appData = {
      "en": {
        ...
        "health_tip_feeding": "Feeding & Management", "health_tip_diseases": "Common Diseases", "health_tip_cause": "Cause", "health_tip_signs": "Signs", "health_tip_first_aid": "First Aid", "health_tip_treatment": "Veterinary Treatment", "health_tip_prevention": "Prevention / Control",
        ...
        "locator_title": "Vet Locator", "locator_subtitle": "Find veterinary services near you.", "locator_map_loading": "Locating...", "locator_call_button": "Call Now", "locator_kspca_desc": "For animal cruelty, neglect, or rescue emergencies, contact the KSPCA.",
        ...
        "about_contact_title": "Contact & Feedback", "about_contact_desc": "Have a suggestion or need a quick consultation? Send a message.",
        "healthTips": {
            "cow": { "title": "Cattle Care & Health", "feeding_management": "Healthy cattle start with proper feeding. A 400 kg cow needs 12 kg of dry matter daily. Mix Napier grass, lucerne, desmodium, and dairy meal. Provide 40–60 L of clean water and a mineral lick. Keep housing clean and spray weekly for ticks.", "diseases": [ { "name": "East Coast Fever", "local_name": "Ndigana kali", "scientific_name": "Theileriosis", "cause": "Caused by the protozoan parasite Theileria parva, transmitted by the brown ear tick (Rhipicephalus appendiculatus).", "signs": "High fever (41-42°C), swollen lymph nodes (especially parotid, prescapular), laboured breathing, watery 'crying' eyes, loss of appetite, and eventual collapse.", "first_aid": "Move to shade, offer clean water, and call a vet urgently. This disease is rapidly fatal and NOT treatable with simple first aid.", "treatment": "Requires specific anti-theilerial drugs (e.g., Buparvaquone) administered by a veterinary professional, often with antibiotics for secondary infections.", "prevention": "Regular and effective tick control (acaricide dipping/spraying), and vaccination with the 'Infection and Treatment Method' (ITM) in endemic areas." }, { "name": "Foot and Mouth Disease", "local_name": "Mdomo na kwato", "signs": "Drooling, blisters in mouth, teats, and feet, refusal to walk.", "first_aid": "Isolate, disinfect feed areas, offer soft feeds.", "prevention": "Vaccinate every 6–12 months." }, { "name": "Anaplasmosis", "local_name": "Mafua ya damu", "signs": "Sudden weakness, yellowing of eyes, fever, dark-brown urine.", "first_aid": "Keep animal calm, shade it, offer water. Contact a vet immediately.", "prevention": "Consistent tick control." }]},
      ...
      "sw": {
        ...
        "health_tip_feeding": "Ulishaji na Usimamizi", "health_tip_diseases": "Magonjwa ya Kawaida", "health_tip_cause": "Chanzo", "health_tip_signs": "Dalili", "health_tip_first_aid": "Huduma ya Kwanza", "health_tip_treatment": "Tiba ya Daktari", "health_tip_prevention": "Kinga / Udhibiti",
        ...
        "locator_title": "Tafuta Daktari", "locator_subtitle": "Pata huduma za mifugo karibu nawe.", "locator_map_loading": "Inatafuta...", "locator_call_button": "Piga Simu Sasa", "locator_kspca_desc": "Kwa ukatili, utelekezaji, au dharura za kuokoa wanyama, wasiliana na KSPCA.",
        ...
        "about_contact_title": "Mawasiliano na Maoni", "about_contact_desc": "Una pendekezo au unahitaji ushauri wa haraka? Tuma ujumbe.",
        "healthTips": {
            "cow": { "title": "Utunzaji na Afya ya Ng'ombe", "feeding_management": "Ng'ombe mwenye afya huanza na ulishaji sahihi. Ng'ombe wa kilo 400 anahitaji kilo 12 za chakula kikavu kila siku. Changanya majani ya napier, lucerne, desmodium, na dairy meal. Mpe lita 40-60 za maji safi na chumvi ya madini. Weka banda safi na puliza dawa ya kupe kila wiki.", "diseases": [ { "name": "Homa ya Pwani (ECF)", "local_name": "Ndigana kali", "scientific_name": "Theileriosis", "cause": "Husababishwa na vimelea vya Theileria parva, vinavyoenezwa na kupe (Rhipicephalus appendiculatus).", "signs": "Homa kali, kuvimba kwa tezi, kupumua kwa shida, macho kutoa maji, kukosa hamu ya kula.", "first_aid": "Mpeleke kivulini, mpe maji safi, na piga simu daktari haraka. Huu si ugonjwa wa huduma ya kwanza.", "treatment": "Inahitaji dawa maalum za kutibu ECF (k.m., Buparvaquone) kutoka kwa daktari wa mifugo.", "prevention": "Udhibiti wa kupe mara kwa mara na chanjo ya ECF." }, { "name": "Ugonjwa wa Miguu na Midomo (FMD)", "local_name": "Mdomo na kwato", "signs": "Kudondosha mate, malengelenge mdomoni, kwenye viwele na miguuni, kukataa kutembea.", "first_aid": "Mtenganishe, safisha maeneo ya kulishia, mpe chakula laini.", "prevention": "Chanjo kila baada ya miezi 6-12." }, { "name": "Anaplasmosis", "local_name": "Mafua ya damu", "signs": "Udhaifu wa ghafla, macho kuwa ya manjano, homa, mkojo wa rangi ya kahawia.", "first_aid": "Mweke mtulivu, kivulini, mpe maji. Wasiliana na daktari mara moja.", "prevention": "Udhibiti thabiti wa kupe." }]},
          ...
          "so": {
            ...
            "health_tip_feeding": "Quudinta & Maareynta", "health_tip_diseases": "Cudurrada Guud", "health_tip_cause": "Sababta", "health_tip_signs": "Calaamadaha", "health_tip_first_aid": "Gargaarka Degdegga ah", "health_tip_treatment": "Daaweynta Dhakhtarka", "health_tip_prevention": "Ka Hortagga / Xakamaynta",
            ...
            "locator_title": "Raadi Dhakhtar", "locator_subtitle": "Ka hel adeegyada caafimaadka xoolaha meel kuu dhow.", "locator_map_loading": "Goobid...", "locator_call_button": "Wac Hadda", "locator_kspca_desc": "Wixii ku saabsan naxariis-darrada, dayacaadda, ama gurmadka degdegga ah ee xoolaha, la xiriir KSPCA.",
            ...
            "about_contact_title": "Xiriir & Fikrad-celin", "about_contact_desc": "Ma haysaa talo soo jeedin ama ma u baahan tahay la-talin degdeg ah? Fariin soo dir.",
            "healthTips": {
                "cow": { "title": "Daryeelka & Caafimaadka Lo'da", "feeding_management": "Lo'da caafimaadka qabta waxay ka bilaabataa quudin habboon. Sac 400 kg ah wuxuu u baahan yahay 12 kg oo walax qalalan maalin kasta. Isku qas cawska Napier, lucerne, desmodium, iyo daqiiqda caanaha. Sii 40-60 L oo biyo nadiif ah iyo macdanta. Guryaha ka dhig kuwo nadiif ah oo toddobaad kasta ku buufi shilinta.", "diseases": [ { "name": "Qandhada Xeebta Bari (ECF)", "local_name": "", "scientific_name": "Theileriosis", "cause": "Waxa sababa dulin (protozoan) la yiraahdo Theileria parva, oo ay gudbiso shilinta (Rhipicephalus appendiculatus).", "signs": "Qandho sare, qanjidhada oo barara, neefsashada oo ku adkaata, indhaha oo ilmeeya, cunto xumo.", "first_aid": "U rari hoos, sii biyo nadiif ah, oo si degdeg ah u wac dhakhtar. Kuma daaweyn kartid gargaarka degdegga ah.", "treatment": "Wuxuu u baahan yahay daawooyin gaar ah (tusaale, Buparvaquone) oo uu bixiyo dhakhtarka xoolaha.", "prevention": "Xakameynta shilinta joogtada ah iyo tallaalka." }, { "name": "Cudurka Cagaha iyo Afka (FMD)", "local_name": "", "signs": "Candhuuf badan, nabarro afka, naasaha, iyo cagaha ka soo baxa, diidmada socodka.", "first_aid": "Go'doomi, jeermi-dil meelaha lagu quudiyo, sii cunto jilicsan.", "prevention": "Tallaal 6-12 bilood kasta." }, { "name": "Anaplasmosis", "local_name": "", "signs": "Tabar-darro degdeg ah, indhaha oo jaale noqda, qandho, kaadi madow-brown ah.", "first_aid": "Xayawaanka deji, hoos geli, sii biyo. Si degdeg ah ula xiriir dhakhtar.", "prevention": "Xakameyn joogto ah oo shilinta." }]},
        ...
        const vetsData = [ { "name": "The KSPCA Vet Clinic", "coords": [-1.3326, 36.7844], "tel": "+254709997500", "address": "Lang'ata South Road, Nairobi" }, { "name": "Small Five Vet Clinic", "coords": [-1.2838, 36.7844], "tel": "+254702624945/020-2001007", "address": "Kilimani, Nairobi" }, { "name": "Andys Veterinary Clinic", "coords": [-1.3005, 36.7628], "tel": "+254713036765", "address": "Ngong Road, Nairobi" }, { "name": "Hardy Veterinary Clinic", "coords": [-1.3499, 36.7501], "tel": "+2547768015191", "address": "Karen, Nairobi" }, { "name": "Parklands Veterinary Clinic", "coords": [-1.2655, 36.8222], "tel": "+254711654615", "address": "Parklands, Nairobi" }, { "name": "Eastlands Pet Clinic", "coords": [-1.2950, 36.8858], "tel": "+25497777179", "address": "Donholm, Nairobi" }, { "name": "Jakaranda Vet Clinic", "coords": [-1.0473, 37.0782], "tel": "+254759892994", "address": "Thika Town, Kiambu" }, { "name": "Membley Vet Clinic", "coords": [-1.1444, 36.9689], "tel": "+254741292939", "address": "Ruiru, Kiambu" }, { "name": "Nakuru Veterinary Centre", "coords": [-0.2833, 36.0667], "tel": "+254795285454", "address": "Nakuru CBD, Nakuru" }, { "name": "Afrivets", "coords": [-0.7167, 36.4333], "tel": "+254722438070", "address": "Naivasha, Nakuru" }, { "name": "Oasis Vet Clinic", "coords": [-4.0333, 39.6833], "tel": "+254740321817", "address": "Nairobi estate, Mombasa" }, { "name": "Petwell Vet Clinic - Coast", "coords": [-4.0500, 39.6667], "tel": "+254734791997", "address": "Mombasa CBD, Mombasa" }, { "name": "Aniworld Veterinary Clinic", "coords": [-0.0917, 34.7680], "tel": "+254708192291", "address": "Kisumu CBD, Kisumu" }, { "name": "Northrift Veterinary Clinic", "coords": [0.5204, 35.2699], "tel": "+254723082862", "address": "Eldoret Town, Uasin Gishu" }, { "name": "Briggits Veterinary Clinic", "coords": [-1.5167, 37.2667], "tel": "+254770546921", "address": "Machakos Town, Machakos" }, { "name": "Kitengela Veterinary services", "coords": [-1.4833, 36.9667], "tel": "+2547226431515", "address": "Kitengela, Kajiado" }, { "name": "Meru Veterinary Services", "coords": [0.0500, 37.6500], "tel": "+254708949190", "address": "Meru Town, Meru" }, { "name": "Jofarm Veterinary Centre", "coords": [-0.4167, 36.9500], "tel": "+254705919232", "address": "Nyeri Town, Nyeri" }, { "name": "Garissa County Vet Services", "coords": [-0.4525, 39.6533], "tel": "+254722566999", "address": "Garissa Town, Garissa" }, { "name": "Lodwar Veterinary Clinic", "coords": [3.1167, 35.6000], "tel": "+254702224066", "address": "Lodwar, Turkana" }, { "name": "Animal haven Vet Clinic", "coords": [0.2833, 34.7500], "tel": "+254754332037", "address": "Kakamega Town, Kakamega" }, { "name": "Kericho Veterinary Services", "coords": [-0.3667, 35.2833], "tel": "+254722751663", "address": "Kericho Town, Kericho" }, { "name": "Bhalloo Vet Clinic", "coords": [-3.2167, 40.1167], "tel": "+254202130667", "address": "Malindi, Kilifi" } ];
        ...
        function renderHealthTipsGrid() {
            ...
            const animalOrder = ['cow', 'sheep_goat', 'chicken', 'pig', 'dog', 'cat'];
            animalOrder.forEach(key => {
                const animal = tips[key]; if (!animal) return;
                const card = document.createElement('div');
                card.className = 'bg-white/80 rounded-lg shadow-md border text-center cursor-pointer hover:shadow-xl hover:border-brand transform hover:-translate-y-1 transition-all overflow-hidden';
                card.dataset.animalKey = key;
                // --- IMAGE CLASS CHANGED TO object-cover ---
                card.innerHTML = `<img src="${animalImages[key]}" alt="${animal.title}" class="w-full h-24 object-cover"><h3 class="font-bold text-brand p-2">${animal.title}</h3>`;
        ...
        function openHealthTipModal(animalKey) {
            ...
            healthModalHeader.innerHTML = `<div class="flex items-center space-x-3"><img src="${animalImages[animalKey]}" alt="${animalData.title}" class="w-10 h-10 object-cover rounded-md"><h2 class="text-xl font-bold text-brand">${animalData.title}</h2></div><button id="modal-close-x" class="text-2xl font-bold p-2 leading-none">&times;</button>`;
            
            let bodyHtml = `<div class="mb-6"><h3 class="text-lg font-semibold border-b-2 pb-1 mb-2">${t.health_tip_feeding}</h3><p class="whitespace-pre-line text-gray-700">${animalData.feeding_management}</p></div><div><h3 class="text-lg font-semibold border-b-2 pb-1 mb-3">${t.health_tip_diseases}</h3><div class="space-y-4">`;
            
            // --- This loop is now upgraded to show the new data ---
            animalData.diseases.forEach(d => {
                bodyHtml += `<div class="bg-white/80 p-4 rounded-lg border shadow-sm text-left">
                    <h4 class="font-bold text-md text-brand">${d.name}</h4>
                    ${d.local_name ? `<p class="text-sm italic text-gray-500 mb-2">${d.local_name}</p>` : ''}
                    ${d.scientific_name ? `<p class="text-xs font-mono text-gray-600 mb-2">(${d.scientific_name})</p>` : ''}
                    
                    ${d.cause ? `<strong>${t.health_tip_cause}:</strong><p class="text-sm mb-2 text-gray-700">${d.cause}</p>` : ''}
                    <strong>${t.health_tip_signs}:</strong><p class="text-sm mb-2 text-gray-700">${d.signs}</p>
                    <strong>${t.health_tip_first_aid}:</strong><p class="text-sm mb-2 text-gray-700">${d.first_aid}</p>
                    ${d.treatment ? `<strong>${t.health_tip_treatment}:</strong><p class="text-sm mb-2 text-gray-700">${d.treatment}</p>` : ''}
                    ${d.prevention ? `<strong>${t.health_tip_prevention}:</strong><p class="text-sm text-gray-700">${d.prevention}</p>` : ''}
                </div>`;
            });
        ...
        function updateAnimalIconPreview() { const type = animalTypeSelect.value; animalIconPreview.innerHTML = type && animalImages[type] ? `<img src="${animalImages[type]}" class="w-full h-full object-cover">` : ''; } // --- IMAGE CLASS CHANGED ---
        ...
        function renderScheduleCard(animal) {
            ...
            // --- IMAGE CLASS CHANGED (removed bg-gray, p-1, border, and object-contain) ---
            let tableHTML = `<div class="flex justify-between items-start mb-4"><div class="flex items-center space-x-4"><img src="${animalImages[animal.type]}" alt="${animal.type}" class="w-16 h-16 rounded-lg object-cover"><div><h3 class="font-bold text-xl text-brand">${animal.name}</h3><p class="text-md text-gray-600">${t[`animal_${animal.type}`]}</p></div></div><button class="remove-btn text-red-500 hover:text-red-700 text-2xl p-1 leading-none">&times;</button></div><div class="overflow-x-auto"><table class="w-full text-sm"><thead class="bg-emerald-50/80 text-brand"><tr><th class="p-2 w-10">${t.th_done}</th><th class="p-2">${t.th_vaccine}</th><th class="p-2">${t.th_due_date}</th></tr></thead><tbody>`;
        ...
        function renderStaticSchedules() {
            ...
            animalOrder.forEach(key => {
                ...
                // --- IMAGE CLASS CHANGED (removed bg-gray, p-1, and object-contain) ---
                contentHTML += `<div class="accordion-item bg-white/80 border rounded-lg shadow-sm overflow-hidden"><button class="accordion-header w-full text-left p-4 font-semibold flex justify-between items-center"><span class="flex items-center"><img src="${animalImages[key]}" alt="${t['animal_'+key]}" class="w-12 h-12 rounded-md mr-4 object-cover"><span class="text-lg">${t['animal_'+key]}</span></span><svg class="w-6 h-6 transform transition-transform" viewBox="0 0 24 24"><path d="M19 9l-7 7-7-7"/></svg></button><div class="accordion-content px-4 pb-4">${table}</div></div>`;
            });
        ...
        function renderReminders() {
            ...
            reminders.forEach(({ animal, item, due }) => {
                ...
                el.innerHTML = `<div class="flex items-center space-x-3"><img src="${animalImages[animal.type]}" alt="${animal.type}" class="w-8 h-8 object-cover rounded-md"><div><p class="font-semibold text-sm">${item.vaccine}</p><p class="text-xs text-gray-600">${animal.name}</p></div></div><p class="text-xs font-medium ${statusClass}">${statusText}</p>`;
